var express = require('express')
  , path = require('path')
  , coinapi = require('chaincoin-node-api')
...
// coin api
coinapi.setWalletDetails(settings.wallet);
if (settings.heavy != true) {
  coinapi.setAccess('only', ['getinfo', 'getnetworkhashps', 'getmininginfo','getdifficulty', 'getconnectioncount',
  ...
  */
  coinapi.setAccess('only', ['getinfo', 'getstakinginfo', 'getnetworkhashps', 'getdifficulty', 'getconnectioncount',
